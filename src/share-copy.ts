...
export const SHARE_COPY_PAYLOAD: ShareCopyPayload = {
  ...
  locales: {
    zh: {
      title: "分享 CryoClaw 给朋友",
      subtitle: "复制下面这段文案分享给你的朋友或群聊，作者会非常感谢你哟😘",
      body: [
        "最近发现一个 OpenClaw 的一键安装包叫做 CryoClaw",
        "几分钟就能装好并开始用",
        "",
        "他们说 OpenClaw 可以做这些事：",
    ...
    en: {
      title: "Share CryoClaw with friends",
      subtitle:
        "Copy this text and share it with your friends or group chats. The creator will really appreciate it 😘",
      body: [
        "I recently found a one-click installer for OpenClaw called CryoClaw",
